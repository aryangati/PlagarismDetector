...
Model: A Multinomial Naive Bayes classifier was chosen for its excellent performance and efficiency in text classification tasks. The model was trained on the popular UCI SMS Spam Collection Dataset.
